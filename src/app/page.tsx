    ...
    <>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-12 py-20 md:py-28">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <a href="#tools-section" className="no-underline px-6 py-3 rounded-[10px] border-[1.5px] border-slate-200 bg-white text-slate-700 text-[15px] font-semibold hover:border-brand-600 transition-all">
              Browse Categories
            </a>
          </div>
        </div>
      ...
      <section className="bg-slate-900">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-12 py-7 flex justify-between flex-wrap gap-5">
          {[
            { num: "40+", label: "Health Tools", icon: "📖" },
            { num: "112K+", label: "Words of Research", icon: "🔬" },
            { num: "WHO/NIH", label: "Cited Sources", icon: "🏛️" },
            { num: "34", label: "Interactive Tools", icon: "📊" },
