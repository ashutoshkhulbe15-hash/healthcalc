  ...
  return (
    <div className="max-w-[760px] mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="text-[15.5px] leading-[1.8] text-slate-600 space-y-4">
        ...
        <p>Email us at: <a href="mailto:hello@prohealthit.com" className="text-brand-600 font-semibold">hello@prohealthit.com</a>
          <p className="text-sm text-slate-400 mt-4">Based in India · Independent health information project · Maintained by Ash K</p></p>
