...
export const metadata: Metadata = { title: "PCOS Macro Calculator — Insulin-Resistant & Anti-Inflammatory Splits",
  description: "PCOS-specific macro calculator adjusted by phenotype (insulin-resistant, inflammatory, adrenal). Includes 10% metabolic adaptation factor. Evidence-based guide.",
  alternates: { canonical: "/fitness/macro-calculator-pcos" }, };
