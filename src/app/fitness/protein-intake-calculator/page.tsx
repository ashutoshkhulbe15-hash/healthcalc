...
export const metadata: Metadata = {
  ...
  description: "Calculate your optimal daily protein intake based on weight, activity level, and goal. Evidence-based recommendations for muscle gain, weight loss, and health.",
};
