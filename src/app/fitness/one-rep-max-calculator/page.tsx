...
export const metadata: Metadata = { title: "One Rep Max Calculator — Estimate Your 1RM", description: "Estimate your one rep max using Brzycki and Epley formulas. Get percentage-based training charts for programming." };
