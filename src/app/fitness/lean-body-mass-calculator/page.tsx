...
export const metadata: Metadata = { title: "Lean Body Mass Calculator — Boer & James Formulas", description: "Calculate your lean body mass using Boer and James formulas. Understand the difference between lean mass and muscle mass." };
