...
export const metadata: Metadata = {
  title: "Calorie Deficit Calculator — Find Your Target for Weight Loss",
  description: "Calculate your optimal calorie deficit for sustainable weight loss. Choose your rate of loss and get a personalized daily calorie target.",
};
