...
export const metadata: Metadata = {
  title: "Macro Calculator — Personalized Protein, Carbs & Fat Targets",
  description: "Get your personalized macronutrient targets for weight loss, muscle building, keto, or maintenance. Evidence-based splits with detailed guide.",
};
