...
export const metadata: Metadata = {
  title: "Fitness & Nutrition — Health Guides & Tools",
  description: "Nutrition planning, body composition, and strength training tools backed by sports science and peer-reviewed research.",
};

export default function CategoryPage() {
  const tools = TOOLS.filter((t) => t.category === "fitness" && t.live);
      ...
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(145deg, #F0FDFA 0%, #ECFDF5 40%, #F0F9FF 100%)" }}>
        ...
        <div className="relative max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-12 pt-8 pb-6">
          <div className="text-[13px] text-slate-500 flex gap-1.5 mb-5">
            ...
            <span className="text-slate-500">Fitness & Nutrition</span>
          </div>
          <div className="flex items-center gap-3 mb-4">
            <span className="text-4xl">💪</span>
            <h1 className="text-3xl md:text-[42px] font-extrabold text-slate-900 tracking-tight">Fitness & Nutrition</h1>
          </div>
          <p className="text-[16px] text-slate-600 max-w-[560px]">Nutrition planning, body composition, and strength training tools backed by sports science and peer-reviewed research.</p>
        </div>
      ...
      <div className="bg-slate-50 -mt-1">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-12 py-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {tools.map((t) => (
              <Link key={t.slug} href={`/fitness/${t.slug}`}
