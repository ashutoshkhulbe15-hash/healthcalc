...
export const metadata: Metadata = { title: "Calorie Calculator for Women Over 50 — Menopause & Metabolic Changes", description: "Calculate daily calorie needs for women 50+. Accounts for age-related metabolic slowdown, menopause, and includes protein targets for sarcopenia prevention.",
  alternates: { canonical: "/body-metrics/calorie-calculator-women-over-50" }, };
