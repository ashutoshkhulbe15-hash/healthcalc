...
export const metadata: Metadata = {
  title: "BMI Calculator for Teenagers — Age & Gender Adjusted",
  description: "Calculate BMI for teens using CDC age-and-sex-specific percentile charts. Understand why adult BMI categories don't apply to adolescents.",
};
