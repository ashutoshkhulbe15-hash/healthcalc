...
export const metadata: Metadata = { title: "Ideal Weight Calculator — 4 Formulas Compared", description: "Calculate your ideal weight using Devine, Robinson, Miller, and Hamwi formulas. Understand what these numbers actually mean." };
