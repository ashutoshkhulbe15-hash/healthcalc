...
export const metadata: Metadata = {
  title: "Fetal Weight Percentile Calculator — WHO Growth Standards by Week",
  description: "Check your baby's estimated weight against WHO fetal growth standards week 20-40. Understand percentiles, SGA, LGA, and what ultrasound estimates mean.",
  alternates: { canonical: "/pregnancy/fetal-weight-percentile" },
};
