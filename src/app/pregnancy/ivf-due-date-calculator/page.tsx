...
export const metadata: Metadata = { title: "IVF Due Date Calculator — 3-Day Embryo & 5-Day Blastocyst Transfer",
  description: "Calculate your IVF due date from embryo transfer date. Supports 3-day and 5-day blastocyst, fresh and frozen (FET) transfers. Gestational age tracker included.",
