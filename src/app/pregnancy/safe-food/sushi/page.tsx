...
export const metadata: Metadata = {
  title: "Can I Eat Sushi During Pregnancy? Safety Guide",
  description: "Is sushi safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
};
...
export default function Page() {
  ...
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Sushi During Pregnancy?"
      description="Evidence-based safety guide for sushi during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
