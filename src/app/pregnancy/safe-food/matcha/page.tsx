...
export const metadata: Metadata = {
  title: "Can I Drink Matcha During Pregnancy?",
  description: "Matcha has 60-70mg caffeine per serving — within ACOG 200mg limit at 1-2 cups daily. Higher caffeine than green tea because whole leaf is consumed. EGCG and preparation guide.",
  alternates: { canonical: "/pregnancy/safe-food/matcha" },
};

export default function Page() {
  const content = getArticleContent("food-matcha.md");
  const lastUpdated = getLastUpdated("food-matcha.md");
  return (
    <ToolPageShell lastUpdated={lastUpdated} category="pregnancy" title="Can I Drink Matcha During Pregnancy?"
