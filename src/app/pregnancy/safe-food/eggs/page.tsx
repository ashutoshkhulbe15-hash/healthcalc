...
export const metadata: Metadata = {
  ...
  description: "Is eggs safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
...
export default function Page() {
  ...
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Eggs During Pregnancy?"
      description="Evidence-based safety guide for eggs during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
