...
export const metadata: Metadata = {
  title: "Can I Eat Soft Cheese During Pregnancy? Safety Guide",
  description: "Is soft cheese safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
};
...
export default function Page() {
  ...
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Soft Cheese During Pregnancy?"
      description="Evidence-based safety guide for soft cheese during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
