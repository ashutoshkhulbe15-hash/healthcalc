...
export const metadata: Metadata = {
  title: "Can I Eat Hot Dogs During Pregnancy? Safety Guide",
  description: "Is hot dogs safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
...
export default function Page() {
  ...
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Hot Dogs During Pregnancy?"
      description="Evidence-based safety guide for hot dogs during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
