...
export const metadata: Metadata = {
  ...
  description: "Is cod safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
};

export default function Page() {
  const content = getArticleContent("food-cod.md");
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Cod During Pregnancy?"
      description="Evidence-based safety guide for cod during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
