...
export const metadata: Metadata = {
  title: "Can I Eat Deli Meats During Pregnancy? Safety Guide",
  description: "Is deli meats safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
};
...
export default function Page() {
  ...
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Deli Meats During Pregnancy?"
      description="Evidence-based safety guide for deli meats during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
