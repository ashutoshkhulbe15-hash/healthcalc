...
export const metadata: Metadata = {
  title: "Can I Eat Pre Made Salads During Pregnancy? Safety Guide",
  description: "Is pre made salads safe during pregnancy? Evidence-based guide with safety rating, nutritional info, preparation tips, and trimester-specific advice.",
};
...
export default function Page() {
  ...
  return (
    <ToolPageShell category="pregnancy" title="Can I Eat Pre Made Salads During Pregnancy?"
      description="Evidence-based safety guide for pre made salads during pregnancy. Includes nutritional info, preparation guidelines, and trimester-specific advice."
