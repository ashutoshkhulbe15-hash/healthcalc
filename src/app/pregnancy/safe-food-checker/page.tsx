...
export const metadata: Metadata = { title: "Pregnancy Safe Food Checker", description: "Check if foods are safe to eat during pregnancy. Searchable database with ACOG and FDA guidelines." };
