...
export const metadata: Metadata = {
  title: "GFR Calculator — Estimate Kidney Function (CKD-EPI 2021)",
  description: "Calculate your estimated GFR using the CKD-EPI 2021 equation. Understand CKD stages, what your creatinine level means, and when to see a nephrologist.",
};
