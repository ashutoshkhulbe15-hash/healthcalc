...
export const metadata: Metadata = { title: "Burnout Quiz — Assess Your Burnout Risk", description: "Take a burnout assessment inspired by the Maslach Burnout Inventory. Measure exhaustion, cynicism, and efficacy." };
