...
export const metadata: Metadata = { title: "Anxiety Self-Assessment — GAD-7 Screening", description: "Take the GAD-7 anxiety screening questionnaire. Understand your anxiety levels with clinically validated scoring." };
