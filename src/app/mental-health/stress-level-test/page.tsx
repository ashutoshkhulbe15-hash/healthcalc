...
export const metadata: Metadata = {
  title: "Stress Level Test — PSS-10 Based Assessment",
  description: "Take a clinically validated stress assessment based on the Perceived Stress Scale (PSS-10). Understand your stress levels and get actionable guidance.",
};
