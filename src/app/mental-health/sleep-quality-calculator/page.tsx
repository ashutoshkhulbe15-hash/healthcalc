...
export const metadata: Metadata = {
  title: "Sleep Quality Calculator — PSQI-Based Assessment",
  description: "Assess your sleep quality using the Pittsburgh Sleep Quality Index. Get a comprehensive score across 7 sleep dimensions with improvement guidance.",
};
