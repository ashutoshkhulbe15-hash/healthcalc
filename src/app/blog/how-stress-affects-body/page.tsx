...
export const metadata: Metadata = {
  title: "How Stress Affects Your Body — Cortisol, Sleep, Weight & Immunity",
  description: "A data-driven look at how chronic stress physically changes your body — from cortisol and the HPA axis to weight gain, sleep disruption, and immune suppression.",
  alternates: { canonical: "/blog/how-stress-affects-body" },
};
...
export default function Page() {
  ...
  return (
    <BlogPageShell
      ...
      url="/blog/how-stress-affects-body">
