...
const NAV_LINKS = [
  {
    ...
    children: [
      ...
      { label: "Safe Food Guide (50 foods)", href: "/pregnancy/safe-food" },
      ...
      { label: "Postpartum Depression", href: "/mental-health/postpartum-depression-screening" },
    ],
  },
  {
    label: "Fitness",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Waist-to-Hip Ratio", href: "/body-metrics/waist-to-hip-ratio-calculator" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Sleep Calculator", href: "/mental-health/sleep-calculator" },
  ...
  },
  {
    label: "Conditions",
    children: [
      { label: "A1C Converter", href: "/conditions/a1c-blood-sugar-converter" },
      { label: "GFR Calculator", href: "/conditions/gfr-calculator" },
      { label: "Kidney Function", href: "/conditions/kidney-function-calculator" },
      { label: "Anemia Risk Checker", href: "/conditions/anemia-risk-checker" },
      { label: "Cholesterol Ratios", href: "/conditions/cholesterol-ratio-calculator" },
      { label: "Vitamin D Calculator", href: "/conditions/vitamin-d-calculator" },
      { label: "Thyroid Function", href: "/conditions/thyroid-function-calculator" },
    ],
  },
  {
    label: "Resources",
    children: [
      { label: "Pregnancy Safe Food Guide", href: "/pregnancy/safe-food" },
      { label: "HCG Levels by Week", href: "/guides/hcg-levels-by-week" },
      { label: "Blood Sugar Levels by Age", href: "/guides/blood-sugar-levels-by-age" },
      { label: "BMI vs Body Fat", href: "/blog/bmi-vs-body-fat-which-matters" },
      { label: "TDEE Complete Guide", href: "/blog/understanding-tdee-complete-guide" },
      { label: "Protein Guide", href: "/blog/protein-how-much-you-need" },
      { label: "Pregnancy Nutrition", href: "/blog/pregnancy-nutrition-guide" },
      { label: "Keto Macros Guide", href: "/guides/keto-macros-how-to-calculate" },
    ],
  },
];
