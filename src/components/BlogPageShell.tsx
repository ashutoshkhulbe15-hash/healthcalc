...
import { AuthorByline, SourcesNote } from "./AuthorByline";
...
export function BlogPageShell({
  ...
  return (
    <>
      ...
      {url && <ArticleSchema title={title} description={subtitle} url={url} category={categoryLabel} dateModified={lastUpdatedISO} />}
      {/* Banner */}
      <section
      ...
      >
        ...
        <div className="relative max-w-[1060px] mx-auto px-4 sm:px-6 pt-5 pb-8 md:pb-12">
          ...
          <div className="mt-5">
            <AuthorByline lastUpdated={lastUpdated} readTime={readTime} accent={accent} />
          </div>
        </div>
      ...
      <div className="bg-slate-50 -mt-1">
        <div className="max-w-[1060px] mx-auto px-4 sm:px-6 py-8">
          {children}
