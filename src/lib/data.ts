...
export const TOOLS = [
  ...
  { slug: "sleep-calculator", name: "Sleep Calculator", category: "mental-health", desc: "Ideal bedtime by sleep cycles and age group.", popular: false, live: true },
  ...
  { slug: "waist-to-hip-ratio-calculator", name: "Waist-to-Hip Ratio", category: "body-metrics", desc: "WHO cardiovascular risk from waist and hip measurements.", popular: false, live: true },
  { slug: "vitamin-d-calculator", name: "Vitamin D Calculator", category: "conditions", desc: "Daily IU needs by body weight and current level.", popular: false, live: true },
  { slug: "thyroid-function-calculator", name: "Thyroid Function Calculator", category: "conditions", desc: "TSH interpretation with pregnancy-adjusted ranges.", popular: false, live: true },
